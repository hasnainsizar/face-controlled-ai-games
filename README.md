...
- pip install opencv-python mediapipe pygame numpy python main.py

## Notes

- This project was built as a learning exercise to better understand real-time input handling, noise filtering, and state-driven game design. Future improvements could include adaptive difficulty, accessibility tuning, or additional games using the same input system.